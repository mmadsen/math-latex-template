...
\title{\Huge{Course Name}\\Problem Set 9}
\author{\huge{Mark Madsen}}
\date{\today}
...
\sol{\textbf{For Property \ref{n:3} for norm-2}	
	\subsubsection*{\textbf{When field is $\bbR:$}} We have to show\begin{align*}
